...
const PortfolioCard = ({ project, index }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className="relative w-full sm:w-80 h-80 rounded-xl m-4 perspective"
    ...
    >
      <div className={`flip-card ${isFlipped ? "flipped" : ""}`}>
        ...
        <div className="flip-card-back rounded-xl overflow-hidden shadow-2xl bg-gradient-to-br from-purple-600 to-blue-500 p-6 flex flex-col justify-center">
          ...
          <button className="mt-auto self-center px-4 py-2 bg-white/10 hover:bg-white/20 transition-colors rounded-full text-sm text-white font-medium">
            View Details
          </button>
        </div>
      </div>
...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-sm p-6 rounded-xl shadow-xl"
      initial={{ opacity: 0, y: 50 }}
      animate={inView ? { opacity: 1, y: 0 } : {}}
      transition={{ delay: index * 0.2, duration: 0.5 }}
...
const FormField = ({ label, type, placeholder, index }) => {
  ...
  return (
    ...
    >
      ...
      {type === "textarea" ? (
        <textarea
          className={`w-full p-3 text-sm bg-gray-800/50 border rounded-lg outline-none transition-all duration-300 ${
            focused
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden">
      ...
      {/* Navigation bar */}
      <nav className="sticky top-0 w-full backdrop-blur-md bg-gray-900/50 z-40 transition-all duration-300">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-6">
            {[
              ...
              { id: "portfolio", ref: portfolioRef, label: "Portfolio" },
      ...
      >
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between">
          ...
          >
            ...
            <p className="text-gray-300 my-6 max-w-lg mx-auto lg:mx-0">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <motion.button
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              ...
              <motion.button
                className="px-6 py-3 border border-white/20 rounded-full font-medium hover:bg-white/10 transition-all"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <motion.button
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full font-medium mt-4"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => scrollToSection(contactRef)}
              >
            ...
            >
              <h3 className="text-2xl font-bold mb-4 text-purple-400">My Skills</h3>
              <div className="mt-6">
      ...
      >
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div
              className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-xl shadow-xl"
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
            >
              ...
              <form>
                ...
                />
                <motion.button
                  className="w-full px-6 py-3 mt-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all"
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 mt-1">+1 234 567 890</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 mt-1">shaon@labancy.com</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 mt-1">New York, NY, USA</p>
                  </div>
                </motion.div>
              </div>
                ...
                <div className="flex space-x-4">
                  ...
                  {["facebook", "twitter", "instagram", "linkedin"].map((social, index) => (
                    <motion.a
                      key={social}
                      href="#"
                      className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-gradient-to-r from-blue-500 to-purple-600 transition-colors"
      ...
      {/* Footer */}
      <footer className="py-10 px-4 bg-gray-900/50 backdrop-blur-md">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <p className="text-gray-400">
                &copy; {new Date().getFullYear()} Labancy. All rights reserved.
              </p>
            </motion.div>
          </div>
        </div>
