...
const MobileNavBar = ({ activeSection }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-gray-900/80 backdrop-blur-lg z-50 shadow-md">
        ...
        {location.pathname === "/" ? (
          <div className="flex space-x-2">
            <motion.button
              ...
              className="px-3 py-1 text-white/80 text-sm rounded-full border border-gray-700 flex items-center"
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white material-button elevation-2"
              whileTap={{ scale: 0.9 }}
            >
...
const Home = () => {
  ...
  // Portfolio projects data for preview (limited)
  ...
  return (
    <div className="mobile-app min-h-screen text-white relative overflow-hidden">
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            className="fixed bottom-6 right-4 w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white flex items-center justify-center shadow-lg z-40 material-fab elevation-3"
            onClick={() => scrollToTop()}
